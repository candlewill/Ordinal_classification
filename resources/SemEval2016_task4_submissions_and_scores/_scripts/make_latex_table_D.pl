...
#  
#  Description: Generates a LaTeX table for the SemEval-2016 Task 4 results, subtask D.
#
...
print '\hline', "\n";
print '  \bf \# & \bf System & \bf KLD & \bf AE & \bf RAE \\\\', "\n";
print '\hline', "\n";
...
print '\hline', "\n";
print '\end{tabular}', "\n";
print '\caption{Results for SemEval-2016 Task 4, subtask D.}', "\n";
